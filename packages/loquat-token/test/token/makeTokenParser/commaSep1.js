/*
 * loquat-token test / token.makeTokenParser().commaSep1()
 */
...
describe(".commaSep1(parser)", () => {
    it("should return a parser that parses one or more tokens separated by commas", () => {
        const def = new LanguageDef({});
        const tp = makeTokenParser(def);
        const commaSep1 = tp.commaSep1;
        expect(commaSep1).to.be.a("function");
        const parser = commaSep1(p);
        assertParser(parser);
        // empty
        {
