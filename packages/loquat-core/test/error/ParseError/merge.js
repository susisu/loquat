...
describe(".merge(errA, errB)", () => {
    it("should return an `IParseError' object that is equal to `errA' if `errB' is unknown but `errA' is not", () => {
    ...
    it("should return an `IParseError' object that is equal to `errB' if `errA' is unknown but `errB' is not", () => {
        let posA = new SourcePos("foobar", 496, 28);
        let msgsA = [];
        let posB = new SourcePos("foobar", 6, 28);
        let msgsB = [
    ...
    it("should return an `IParseError' object that is equal to `errA' if `errA.pos' is behind `errB.pos'", () => {
        let posA = new SourcePos("foobar", 496, 28);
        let msgsA = [
            new ErrorMessage(ErrorMessageType.SYSTEM_UNEXPECT, "foo"),
            new ErrorMessage(ErrorMessageType.UNEXPECT, "bar"),
    ...
    it("should return an `IParseError' object that is equal to `errB' if `errB.pos' is behind `errA.pos'", () => {
    ...
    it("should return an `IParseError' object with error messages of `errA' and `errB' concatenated"
