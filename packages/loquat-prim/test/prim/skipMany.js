/*
 * loquat-prim test / prim.skipMany()
 */
...
describe(".skipMany(parser)", () => {
    it("should return a parser that runs `parser' until it empty fails and discards the resultant values", () => {
        ...
        // cerr
        {
            ...
            const manyParser = skipMany(parser);
