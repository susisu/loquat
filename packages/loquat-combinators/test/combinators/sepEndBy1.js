/*
 * loquat-combinators test / combinators.sepEndBy1()
 */
...
describe(".sepEndBy1(parser, sep)", () => {
  it("should return a parser that parses one or more tokens accepted by `parser' separated or"
