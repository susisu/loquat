/*
 * loquat-monad test / monad.replicateM()
...
const replicateM = _monad.replicateM;

describe(".replicateM(num, parsers)", () => {
    it("should return a parser that runs `parsers' `num' times sequentially and returns values as an array", () => {
        ...
        // empty
        {
            ...
            let repParser = replicateM(0, parser);
        ...
        // csuc, csuc
        {
            ...
            let repParser = replicateM(2, parser);
            assertParser(repParser);
            let res = repParser.run(initState);
            expect(Result.equal(
                res,
