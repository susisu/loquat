    ...
    // csucc, csucc, csucc, cfail
    {
      ...
      const states = [
        new State(
          new Config(),
          "restA",
          new SourcePos("foobar", 1, 1, 2),
          "someA"
        ),
        new State(
          new Config(),
          "restB",
          new SourcePos("foobar", 2, 1, 3),
          "someB"
        ),
        new State(
          new Config(),
          "restC",
          new SourcePos("foobar", 3, 1, 4),
          "someC"
        ),
      ];
      const errs = [
